...
def main():
    ...
    candytopia = ImageTk.PhotoImage(Image.open("./images/candytopia.png"))
    hidden_room_1 = ImageTk.PhotoImage(Image.open("./images/hidden_room1.png"))
    hidden_room_2 = ImageTk.PhotoImage(Image.open("./images/hidden_room2.png"))
    ...
    health100 = ImageTk.PhotoImage(Image.open("./images/monster-h100.png"))
    health75 = ImageTk.PhotoImage(Image.open("./images/monster-h75.png"))
    health50 = ImageTk.PhotoImage(Image.open("./images/monster-h50.png"))
    health25 = ImageTk.PhotoImage(Image.open("./images/monster-h25.png"))
    health0 = ImageTk.PhotoImage(Image.open("./images/monster-h0.png"))
    youlose = ImageTk.PhotoImage(Image.open("./images/gameover.png"))
    youwin = ImageTk.PhotoImage(Image.open("./images/winner.gif"))
    ...
    def updateView():
        ...
        # removes previous images from the view
